...
namespace Gb.Gps.WebHost.Controllers
{
    ...
    public class RankController : ControllerBase
    {
        ...
        {
            var ranks = await _rankService.GetAllAsync( cancellationToken );
        ...
        {
            var rankDto = await _rankService.GetByIdAsync( id, cancellationToken );
        ...
        {
            var result = await _rankService.CreateAsync( _mapper.Map<CreateRankModel, CreateRankDto>( createRankModel ), cancellationToken );
        ...
        {
            var wasUpdated = await _rankService.UpdateAsync( id, _mapper.Map<UpdateRankModel, UpdateRankDto>( updateRankModel ), cancellationToken );
        ...
        {
            var wasDeleted = await _rankService.DeleteAsync( id, cancellationToken );
